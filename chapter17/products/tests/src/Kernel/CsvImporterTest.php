...
class CsvImporterTest extends KernelTestBase {
  ...
  public function testImport() {
    ...
    $csv_path = $this->container->get('extension.path.resolver')->getPath('module', 'csv_importer_test') . '/products.csv';
    $csv_contents = file_get_contents($csv_path);
    $file = $this->container->get('file.repository')->writeData($csv_contents, 'public://simpletest-products.csv', FileSystemInterface::EXISTS_REPLACE);
